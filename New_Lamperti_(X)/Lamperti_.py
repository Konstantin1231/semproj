...
ax1.grid()
plt.savefig(f'MAIN_bid_delta_time_{k}_Lamperti_over_time({alpha_1},{alpha_0},{sigma_1},Time={T}).svg')
plt.show()
...
ax1.grid()
plt.savefig(f'MAIN_bid_delta_time_{k}_compare_quadratique_estimateur_over_time({alpha_1},{alpha_0},{sigma_1},Time={T}).svg')
plt.show()
...
ax1.grid()
plt.savefig(f'MAIN_bid_delta_time_{k}_Lamperti_error({alpha_1},{alpha_0},{sigma_1},Time={T}).svg')
plt.show()
...
ax1.grid()
plt.savefig(f'MAIN_bid_delta_time_{k}_compare_quadratique_estimateur_stat({alpha_1},{alpha_0},{sigma_1},Time={T}).svg')
plt.show()
